...
<?php include('./includes/nav.php')?>
    <h2 class="text-center">Electricity No Objection Application</h2>
<form class="form-horizontal" action="./utilityscripts/elecnocapply.php" method="POST" enctype="multipart/form-data" onsubmit="return validateForm()">
  <div class="col-sm-6">
