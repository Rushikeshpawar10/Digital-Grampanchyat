...
<head>
    ...
    <script src="./js/birthreg.js"></script>
</head>
<body style="font-size: 100%;">
<?php include('./includes/nav.php')?>
    <h2 class="text-center">Death / Birth Registration Application</h2>
  <form class="form-horizontal" action="./utilityscripts/deathregapply.php" method="POST" enctype="multipart/form-data" onsubmit="return validateForm()">
    <div class="col-sm-6">
    ...
    <div class="col-sm-6">
      <div class="form-group">
        ...
        <div class="col-sm-8">
          <select id="formtypeselect" class="form-select" aria-label="Default select example" name="type" onchange="checkForm()" required>
    ...
    <div class="container-fluid">
      ...
      <div class="col-sm-6">
        <div class="form-group">
          ...
          <div class="col-sm-8">
            <input type="text" class="form-control user-name" name="pname" required>
          </div>
        </div>
      </div>
      ...
      <div class="col-sm-6">
        <div class="form-group">
          ...
          <div class="col-sm-8">
            <input id="birthdoe" type="text" class="form-control" name="dob" required>
          </div>
        </div>
      </div>
      ...
      <div class="col-sm-6">
        <div class="form-group">
          ...
          <div class="col-sm-8">
            <input id="deathage" type="number" class="form-control" name="age">
          </div>
        </div>
      </div>
      ...
      <div class="col-sm-6">
        <div class="form-group">
          ...
          <div class="col-sm-8">
            <input type="text" class="form-control user-name" name="fname" required>
          </div>
        </div>
      </div>
      ...
      <div class="col-sm-6">
        <div class="form-group">
          ...
          <div class="col-sm-8">
            <input type="text" class="form-control user-name" name="mname"required>
          </div>
        </div>
      </div>
      ...
      <div class="col-sm-6">
        <div class="form-group">
          ...
          <div class="col-sm-8">
            <input id="deathreason" type="text" class="form-control" name="reason">
          </div>
        </div>
      </div>
      ...
      <div class="col-sm-6">
        <div class="form-group">
          ...
          <div class="col-sm-8">
            <textarea type="text" class="form-control" rows="2" name="paddress" required></textarea>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container-fluid">
        ...
        <div class="mb-3">
        <label for="formFile" class="form-label">Dead Person/Parents Ration Card / Aadhaar Card / Voter ID Card</label>
        <input id="deathproof" class="form-control" type="file" id="formFile" name="daadhaar" required accept=".jpg,.jpeg">
        </div>
    </div>
    <div class="col-12">
