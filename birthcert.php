...
<head>
  ...
  <script src="./js/birthcert.js"></script>
</head>

<body style="font-size: 100%;">
  <?php include('./includes/nav.php')?>
  <h2 class="text-center">Birth / Death / Marriage Certificate Application</h2>
  <form class="form-horizontal" action="./utilityscripts/birthcertapply.php" method="POST" enctype="multipart/form-data" onsubmit="return validateForm()">
    <div class="col-sm-6">
      <div class="form-group">
        <label class="control-label col-sm-4">Applicant Name</label>
        <div class="col-sm-8">
          <input id="user-name" type="text" class="form-control user-name" name="aname" required>
        </div>
      </div>
    </div>
    ...
    <div class="col-sm-6">
      <div class="form-group">
        ...
        <div class="col-sm-8">
          <select id="formtypeselect" onchange="checkForm()" class="form-select" aria-label="Default select example" name="type" required>
    ...
    <div class="container-fluid">
      ...
      <div class="col-sm-6">
        <div class="form-group">
          ...
          <div class="col-sm-8">
            <input id="birthpname" type="text" class="form-control user-name" name="pname">
          </div>
        </div>
      </div>
      ...
      <div class="col-sm-6">
        <div class="form-group">
          ...
          <div class="col-sm-8">
            <input id="birthdoe" type="text" class="form-control" name="doe">
          </div>
        </div>
      </div>
      ...
      <div class="col-sm-6">
        <div class="form-group">
          ...
          <div class="col-sm-8">
            <input id="birthfname" type="text" class="form-control user-name" name="fname">
          </div>
        </div>
      </div>
      ...
      <div class="col-sm-6">
        <div class="form-group">
          ...
          <div class="col-sm-8">
            <input id="birthmname" type="text" class="form-control user-name" name="mname">
          </div>
        </div>
      </div>
      ...
      <div class="col-sm-6">
        <div class="form-group">
          ...
          <div class="col-sm-8">
            <textarea id="birthpadd" type="text" class="form-control" rows="2" name="paddress"></textarea>
          </div>
        </div>
      </div>
    </div>
