...
<body style="font-size: 100%;">
    ...
    <form class="form-horizontal" action="./utilityscripts/watertankerapply.php" method="POST" enctype="multipart/form-data" onsubmit="return validateForm()">
        <div class="col-sm-6">
        ...
        <div class="col-sm-6">
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <input type="number" class="form-control" name="socialamount" required>
                </div>
            </div>
        </div>
        <div class="col-12">
