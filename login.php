...
<div id="logreg-forms">
    ...
    <button class="btn btn-primary btn-block text-dark" type="button" id="btn-signup"><i class="fas fa-user-plus"></i><a class="text-light" href="./register.php">Sign up For New Account</a></button>
    </form>
