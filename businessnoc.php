...
<body style="font-size: 100%;">
  ...
  <h2 class="text-center">Business No Objection Certificate Application</h2>
  <form class="form-horizontal" action="./utilityscripts/businessnocapply.php" method="POST" enctype="multipart/form-data" onsubmit="return validateForm()">
    <div class="col-sm-6">
    ...
    <div class="col-sm-6">
      <div class="form-group">
        ...
        <div class="col-sm-8">
          <input type="text" class="form-control user-name" name="certname" required>
        </div>
      </div>
    </div>
